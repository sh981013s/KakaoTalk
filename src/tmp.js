...
function App() {
	...
	const content = (
		<div style={{ height: 500, borderRadius: 20 }}>
			<Menu onClick={handleClick} selectedKeys={[current]} mode="horizontal">
				...
				<Menu.Item key="sample">Navigation One</Menu.Item>
			</Menu>
			{current === 'mail' ? <>asdfasldkfjlasd;.</> : <>safmaslndf</>}
		</div>
	);
	...
	return (
		<>
			...
			<Button
				style={{ backgroundColor: buttonState ? '' : 'yellow' }}
				disabled={buttonState}
			>
				{buttonState ? 'Add Friends' : '다이다이'}
			</Button>
